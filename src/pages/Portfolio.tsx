...
const projects = [
  {
    ...
    summary: "Automated internal workflows, reducing manual effort by 60% and improving data accuracy.",
  ...
  },
  {
    ...
    summary: "Developed a HIPAA-compliant chatbot for patient engagement and appointment scheduling.",
  ...
  },
  {
    ...
    summary: "Fine-tuned LLMs for financial document analysis, enabling rapid insights for analysts.",
...
const Portfolio: React.FC = () => (
  <div className="max-w-7xl mx-auto py-12 px-4 md:px-8">
    <h2 className="text-3xl font-bold text-center mb-10 text-gray-800">Our Portfolio</h2>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {projects.map((project) => (
        ...
        >
          <img src={project.logo} alt={project.name + ' logo'} className="w-16 h-16 mb-4 rounded-full object-cover border border-gray-200" />
          ...
          <ul className="flex flex-wrap justify-center gap-2 mb-4">
            {project.tech.map((tech) => (
              <li key={tech} className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-medium">
                {tech}
              </li>
            ))}
          </ul>
